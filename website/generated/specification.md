...
export interface BuildClientCapabilities {
   ...
   * supply destinations in another way. For example, the server can choose to
   * supply target-destination pairs in workspace/buildTargets. */
  buildTargetDestinationsReceiver?: boolean;
...
export interface BuildServerCapabilities {
  ...
  /** The server can provide a list of destinations for a build target via
   * buildTarget/destinations. */
  buildTargetDestinationsProvider?: boolean;
...
export interface CompileParams {
  ...
  /** The destination for which the compilation should be performed. */
...
export interface RunParams {
  ...
  /** The destination on which the running should be performed. */
  destination?: DestinationIdentifier;
...
export interface TestParams {
  ...
  /** The destination on which the testing should be performed. */
  destination?: DestinationIdentifier;
...
export interface DebugSessionParams {
  ...
  /** The destination on which the debugging should be performed. */
  destination?: DestinationIdentifier;
