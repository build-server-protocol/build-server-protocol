...
object Bsp4jArbitrary {
  ...
  implicit val arbTestFinished: Arbitrary[TestFinished] = Arbitrary(genTestFinished)
  ...
  implicit val arbTestStarted: Arbitrary[TestStarted] = Arbitrary(genTestStarted)
