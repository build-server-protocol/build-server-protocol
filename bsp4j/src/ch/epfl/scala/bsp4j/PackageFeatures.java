...
public class PackageFeatures {
  ...
  public boolean equals(final Object obj) {
    ...
    if (this.availableFeatures == null) {
      if (other.availableFeatures != null)
        return false;
    } else if (!this.availableFeatures.equals(other.availableFeatures))
      return false;
  ...
  public int hashCode() {
    ...
    result = prime * result + ((this.availableFeatures== null) ? 0 : this.availableFeatures.hashCode());
