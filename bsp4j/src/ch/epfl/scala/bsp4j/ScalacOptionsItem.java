...
public class ScalacOptionsItem {
  ...
  public boolean equals(final Object obj) {
    ...
    } else if (!this.options.equals(other.options)) return false;
    ...
    if (this.classDirectory == null) {
      if (other.classDirectory != null) return false;
    } else if (!this.classDirectory.equals(other.classDirectory)) return false;
    return true;
  }
