...
public class DisableCargoFeaturesParams {
  @NonNull
  ...
  public DisableCargoFeaturesParams(@NonNull final String packageId, @NonNull final List<String> features) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    DisableCargoFeaturesParams other = (DisableCargoFeaturesParams) obj;
