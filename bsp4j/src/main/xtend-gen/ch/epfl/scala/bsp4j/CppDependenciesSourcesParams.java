...
public class CppDependenciesSourcesParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;
  
  private String originId;
  
  public CppDependenciesSourcesParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CppDependenciesSourcesParams other = (CppDependenciesSourcesParams) obj;
