...
public class RustToolchainParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;

  public RustToolchainParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    RustToolchainParams other = (RustToolchainParams) obj;
