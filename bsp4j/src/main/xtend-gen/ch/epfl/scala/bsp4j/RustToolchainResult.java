...
public class RustToolchainResult {
  @NonNull
  private List<RustToolchain> toolchains;

  public RustToolchainResult(@NonNull final List<RustToolchain> toolchains) {
    this.toolchains = toolchains;
  }

  @Pure
  @NonNull
  public List<RustToolchain> getToolchains() {
    return this.toolchains;
  }

  public void setToolchains(@NonNull final List<RustToolchain> toolchains) {
