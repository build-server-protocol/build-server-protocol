...
public class RustMetadataParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;

  public RustMetadataParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    RustMetadataParams other = (RustMetadataParams) obj;
