...
public class RustDepMapper {
  ...
  public RustDepMapper(@NonNull final String source, @NonNull final String target, final String name, final List<RustDepKindInfo> depKinds) {
    this.source = source;
    this.target = target;
    this.name = name;
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    RustDepMapper other = (RustDepMapper) obj;
    if (this.source == null) {
