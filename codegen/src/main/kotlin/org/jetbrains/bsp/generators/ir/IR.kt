...
data class Field(val name: String, val type: IrShape, val required: Boolean, val hints: List<Hint>)

data class PolymorphicDataKind(val kind: String, val shape: IrShape, val hints: List<Hint>)
