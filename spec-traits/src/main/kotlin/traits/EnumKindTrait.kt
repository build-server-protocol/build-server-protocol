...
class EnumKindTrait private constructor(builder: Builder) :
    AbstractTrait(ID, builder.sourceLocation), ToSmithyBuilder<EnumKindTrait> {
  ...
  init {
    enumKind =
        builder.enumKind ?: throw SourceException("An enumKind must be provided", sourceLocation)
  }
