...
trait SourceItem {
  ...
  /** Specifies whether uri denotes a directory or regular file. 
    * If this is not set, and the uri does not point to an existing file, it should be treated as directory by default. */
  def isDirectory: Option[Boolean]
