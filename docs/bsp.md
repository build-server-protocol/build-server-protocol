...
trait SourceItem {
  ...
  /** The category of this source item, must be one of SourceItemKind. */
  def kind: Int
}
object SourceItemKind {
  /** Source code that is manually edited by the user. */
  val Source = 1
  /** Data files that are manually managed by the user. */
  val Resource = 2
  /** Source code that is automatically generated by the build and is not
