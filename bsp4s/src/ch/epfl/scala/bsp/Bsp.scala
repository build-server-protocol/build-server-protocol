...
object JvmCompileClasspathItem {
  implicit val codec: JsonValueCodec[JvmCompileClasspathItem] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object JvmCompileClasspathParams {
  implicit val codec: JsonValueCodec[JvmCompileClasspathParams] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object JvmCompileClasspathResult {
  implicit val codec: JsonValueCodec[JvmCompileClasspathResult] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object JvmSourceItemData {
  implicit val codec: JsonValueCodec[JvmSourceItemData] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object RustDepKindInfo {
  implicit val codec: JsonValueCodec[RustDepKindInfo] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object RustDependency {
  implicit val codec: JsonValueCodec[RustDependency] = JsonCodecMaker.makeWithRequiredCollectionFields
}
...
object RustWorkspaceParams {
  implicit val codec: JsonValueCodec[RustWorkspaceParams] = JsonCodecMaker.makeWithRequiredCollectionFields
}
