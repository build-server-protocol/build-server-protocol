 ...
 */
object publishDiagnostics extends Endpoint[PublishDiagnosticsParams, Unit]("build/publishDiagnostics")
 ...
 */
object initialize extends Endpoint[InitializeBuildParams, InitializeBuildResult]("build/initialize")
 ...
 */
object inverseSources extends Endpoint[InverseSourcesParams, InverseSourcesResult]("buildTarget/inverseSources")
 ...
 * dependency sources.
 */
object dependencySources extends Endpoint[DependencySourcesParams, DependencySourcesResult]("buildTarget/dependencySources")
 ...
 */
object outputPaths extends Endpoint[OutputPathsParams, OutputPathsResult]("buildTarget/outputPaths")
 ...
 * targets.
 */
object javacOptions extends Endpoint[JavacOptionsParams, JavacOptionsResult]("buildTarget/javacOptions")
 ...
 */
object jvmCompileClasspath extends Endpoint[JvmCompileClasspathParams, JvmCompileClasspathResult]("buildTarget/jvmCompileClasspath")
...
object scalaMainClasses extends Endpoint[ScalaMainClassesParams, ScalaMainClassesResult]("buildTarget/scalaMainClasses")
}
 ...
 */
object setCargoFeatures extends Endpoint[SetCargoFeaturesParams, SetCargoFeaturesResult]("workspace/setCargoFeatures")
}
